...
Use this reference when creating a complex skill, improving a weak skill, or adapting good ideas from another skill collection. The goal is to turn a skill from a reminder list into an operational guide that changes Claude Code's behavior.
...
- Hides detailed references without telling Claude Code when to read them
...
A strong skill tells Claude Code what should vary. This prevents repetitive, template-shaped output.
...
Do not end a skill at generation. Tell Claude Code how to know the output worked.
