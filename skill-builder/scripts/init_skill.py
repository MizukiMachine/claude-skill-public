...
[TODO: Explain what should change by context so Claude Code does not collapse into one template.]
...
- `references/` for detailed documentation Claude Code should load conditionally
...
Files not intended to be loaded into context, but used within the output Claude Code produces.
...
- [TODO: Name the situation where Claude Code should read this reference]
