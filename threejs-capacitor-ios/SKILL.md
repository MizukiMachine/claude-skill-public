...
description: "Vite と Swift Package Manager を使って、Capacitor iOS 上で Three.js アプリを構築・リリースする。GLTF読み込み、assets_index によるアニメーションUI、OrbitControls のマウス/タッチ対応、iOS の sync/run のトラブルシュートを扱う。"
---
