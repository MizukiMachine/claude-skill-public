...
- [Quick Assessment](#quick-assessment-5-minutes)
- [Complete Audit](#complete-audit)
- [Framework-Specific Checks](#framework-specific-checks)
...
### Nuxt/Vue
- [ ] Nuxt pages use `useSeoMeta`, `useServerSeoMeta`, or `useHead` consistently
- [ ] Canonical links and JSON-LD are emitted during initial render
- [ ] Site-wide defaults do not overwrite page-specific metadata
- [ ] Plain Vue SPA has SSR, SSG, or prerendering for SEO-critical routes
