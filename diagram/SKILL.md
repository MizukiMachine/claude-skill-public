...
- スキル自体を更新した場合:
  ...
  ```bash
  python3 /home/mizuki2/.claude/skills/skill-builder/scripts/quick_validate.py /home/mizuki2/.claude/skills/diagram
  ```

- 図を生成した場合:

  ```bash
  python3 /home/mizuki2/.claude/skills/diagram/scripts/render_diagrams.py diagrams --scale 4
  ```
