...
This layer is identical across iOS and Android — it is pure Three.js / web code.
...
Keep `.glb` files under `public/assets/` so Vite copies them verbatim into
`dist/` and Capacitor ships them in the APK/AAB assets.
